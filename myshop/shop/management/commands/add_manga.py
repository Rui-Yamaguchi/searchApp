...
class Command(BaseCommand):
    help = 'Add manga information to the database'
    ...
    def handle(self, *args, **kwargs):
        mangas = [
            ...
            {'title': 'DRAGON BALL', 'author': '鳥山明', 'price': 500, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'doragonnbo-ru.jpg'},
            ...
            {'title': 'HUNTER×HUNTER', 'author': '冨樫義博', 'price': 400, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'hunterxhunter.jpg'},
            ...
            {'title': 'からかい上手の高木さん', 'author': '山本崇一朗', 'price': 490, 'volume_number': 1, 'publisher': '小学館', 'image_name': 'karakai_jouzu_no_takagi_san.jpg'},
            {'title': '鬼滅の刃', 'author': '吾峠呼世晴', 'price': 460, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'kimetsu_no_yaiba.jpg'},
            {'title': 'キングダム', 'author': '原泰久', 'price': 560, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'kingdom.jpg'},
            {'title': '名探偵コナン', 'author': '青山剛昌', 'price': 420, 'volume_number': 1, 'publisher': '小学館', 'image_name': 'detective_conan.jpg'},
            {'title': 'こちら葛飾区亀有公園前派出所', 'author': '秋本治', 'price': 760, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'kochikame.jpg'},
            ...
            {'title': 'SPY×FAMILY', 'author': '遠藤達哉', 'price': 500, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'spyfamily.jpg'},
            {'title': 'スラムダンク', 'author': '井上雄彦', 'price': 700, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'slamdunk.jpg'},
            {'title': '花より男子', 'author': '神尾葉子', 'price': 410, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'hanayoridango.jpg'},
            {'title': '東京卍リベンジャーズ', 'author': '和久井健', 'price': 510, 'volume_number': 1, 'publisher': '講談社', 'image_name': 'tokyorevengers.jpg'},
            {'title': 'トリコ', 'author': '島袋光年', 'price': 620, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'toriko.jpg'},
            {'title': '東京喰種トーキョーグール', 'author': '石田スイ', 'price': 630, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'tokyoghoul.jpg'},
            {'title': 'ONE PIECE', 'author': '尾田栄一郎', 'price': 420, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'onepiece.jpg'},
            {'title': '約束のネバーランド', 'author': '白井カイウ & 出水ぽすか', 'price': 560, 'volume_number': 1, 'publisher': '集英社', 'image_name': 'yakusoku_no_neverland.jpg'},
            {'title': '妖怪ウォッチ', 'author': '小西紀行', 'price': 450, 'volume_number': 1, 'publisher': '小学館', 'image_name': 'youkaiwatch.jpg'},
        ]
        ...
        self.stdout.write(self.style.SUCCESS("Successfully added all manga volumes"))